# Tweak Up
A curated list of iOS Jailbreak Tweaks that help you unlock the latest features on older iOS versions. Additionally, references to unlock iOS/ iPadOS features on jailed devices are available.  This guide is organized by iOS version to help you quickly find the tweaks you need. Please open an issue, if anything is missing or contains false informations.
...
It is possible to unlock almost every feature on factory (jailed) iOS like AOD, StageManager and much more up to iOS 18.0 RC or 18.1b1. Please refer to the [Nugget GitHub Repo](https://github.com/leminlimez/Nugget) for Nugget or [MisakaX Github Repo](https://github.com/straight-tamago/misakaX) for downloads and support. Feature list below is outdated, much more features have been added by the devs to both tools, please check the provided links above for current state. 
